...
loopFilter = TF2(b0,b1,b2,a1,a2)
	   with{
		...
		loopFilterb0 = ffunction(float getValueLoopFilterb0(float), <stklib.h>,"");
		loopFilterb1 = ffunction(float getValueLoopFilterb1(float), <stklib.h>,"");
		loopFilterb2 = ffunction(float getValueLoopFilterb2(float), <stklib.h>,"");
		loopFiltera1 = ffunction(float getValueLoopFiltera1(float), <stklib.h>,"");
		loopFiltera2 = ffunction(float getValueLoopFiltera2(float), <stklib.h>,"");
