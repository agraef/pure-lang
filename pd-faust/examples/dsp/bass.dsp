...
reflexionFilter = poleZero(b0,b1,a1)
	   with{
		...
		loopFilterb0 = ffunction(float getValueBassLoopFilterb0(float), <stklib.h>,"");
		loopFilterb1 = ffunction(float getValueBassLoopFilterb1(float), <stklib.h>,"");
		loopFiltera1 = ffunction(float getValueBassLoopFiltera1(float), <stklib.h>,"");
